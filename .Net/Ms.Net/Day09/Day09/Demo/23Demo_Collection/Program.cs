...
namespace _23Demo_Collection
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine(  "Enter No to find Emp Object Collection: ");
            ...
            #region List<Object> is like ArrayList
            ...
            //Console.WriteLine("-----------------------------------");
            //Console.WriteLine("Printing all objects data");
            //foreach (int key in arr.Keys)
            //{
            //    Emp employee = arr[key];
